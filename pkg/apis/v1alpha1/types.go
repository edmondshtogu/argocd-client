...
import (
	...
	gitopsengine "github.com/edmondshtogu/argocd-client/pkg/gitops-engine"
	synccommon "github.com/edmondshtogu/argocd-client/pkg/gitops-engine"
...
type HealthStatus struct {
	...
	Status gitopsengine.HealthStatusCode `json:"status,omitempty" protobuf:"bytes,1,opt,name=status"`
