...
import (
	...
	"github.com/edmondshtogu/argocd-client/pkg/clientset/versioned/scheme"
...
func (c *ApisV1alpha1Client) AppProjects(namespace string) AppProjectInterface {
	return newAppProjects(c, namespace)
}

func (c *ApisV1alpha1Client) Applications(namespace string) ApplicationInterface {
	return newApplications(c, namespace)
}

func (c *ApisV1alpha1Client) ApplicationSets(namespace string) ApplicationSetInterface {
